/* ==========================================================================
   Main JS — Menu, Dropdown, Accordion, CV, Forms, Smooth Scroll
   ========================================================================== */
...
function init() {
  ...
  document.querySelectorAll('.header__mobile-dropdown-trigger').forEach(trigger => {
    trigger.addEventListener('click', () => {
      const submenu = trigger.nextElementSibling as HTMLElement;
  ...
  document.querySelectorAll('.header__dropdown').forEach(dropdown => {
    const trigger = dropdown.querySelector('.header__dropdown-trigger') as HTMLElement;
